...
import { getPointOfInterestById, updatePointOfInterestById } from 'apiSdk/point-of-interests';
...
function PointOfInterestEditPage() {
  ...
  const handleSubmit = async (values: PointOfInterestInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updatePointOfInterestById(id, values);
      mutate(updated);
      resetForm();
